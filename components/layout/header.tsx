      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4 text-xs">
          ...
          <a
            ...
            className="hidden items-center gap-1.5 rounded-full border border-gray-600 bg-white/5 px-3 py-1 text-xs text-gray-300 transition-all hover:border-gray-400 hover:bg-white/10 hover:text-white sm:flex"
          >
